...
export interface Project {
   ...
   */
  features?: ('aws-comprehend' | 'aws-textract' | 'batched-reference-searches' | 'bots' | 'cron' | 'email' |
      'google-auth-required' | 'graphql-introspection' | 'terminology' | 'websocket-subscriptions')[];
